...
public class Ajuda extends ListenerAdapter {
	...
	public void onMessageReceived(MessageReceivedEvent event) {
		...
		if(event.getMessage().getContentRaw().equalsIgnoreCase("!ajuda")) {
			
		//	event.getChannel().sendMessage("informações de ajuda").queue();	
